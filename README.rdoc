...
== Motivation
  ...
  Movie.inside_category(genres_category)
  #=> [horror_movie, action_movie]
  Movie.inside_category(horror_category)
  #=> [horror_movie]
  Movie.inside_category(cult_horror_category)
  #=> [horror_movie]
...
Replaces the categories for the given ones.
